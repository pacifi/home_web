...
app.config(function($mdIconProvider, $$mdSvgRegistry) {
    ...
    $stateProvider.state("home", {
        ...
        views: {
            "": {
                templateUrl: "app/views/layouts/home_layuot.html"
            }
        },
        loginRequired: false
    }).state("home.home", {
        ...
        templateUrl: "/app/views/layouts/voucher.html",
        ...
        templateUrl: "/app/views/layouts/login.html",
        ...
        templateUrl: "/app/views/layouts/logout.html",
...
app.run(function($rootScope, $state, $stateParams, $window) {
    ...
    oauth2Service.clientId = "o5W31ZGx7XrCp4B4f6Mr0HMryYyUMuswMpL0LLi4";
